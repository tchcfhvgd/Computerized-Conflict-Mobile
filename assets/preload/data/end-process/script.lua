...
function onStepHit()
	if curStep == 1670 then
		noteTweenX(defaultPlayerStrumX0, 4, defaultPlayerStrumX0, 0.6)
        noteTweenX(defaultPlayerStrumX1, 5, defaultPlayerStrumX1, 0.6)
        noteTweenX(defaultPlayerStrumX2, 6, defaultPlayerStrumX2, 0.6)
        noteTweenX(defaultPlayerStrumX3, 7, defaultPlayerStrumX3, 0.6)

        noteTweenX(defaultOpponentStrumX0, 0, defaultOpponentStrumX0, 0.6)
        noteTweenX(defaultOpponentStrumX1, 1, defaultOpponentStrumX1, 0.6)
        noteTweenX(defaultOpponentStrumX2, 2, defaultOpponentStrumX2, 0.6)
        noteTweenX(defaultOpponentStrumX3, 3, defaultOpponentStrumX3, 0.6)
	end
end
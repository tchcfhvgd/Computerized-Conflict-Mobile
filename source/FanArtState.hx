...
class FanArtState extends MusicBeatState
{
	...
	function changeImage(number:Int = 0)
	{
		...
		var colorToTween:FlxColor = 0xFFFFFFFF;
		switch(actualNum) //shittest code ever fr
		{
			case 0:
				colorToTween = 0xFFE4D837;
			case 1:
				colorToTween = 0xFF28A8C8;
			case 2:
				colorToTween = 0xFFD60600;
		}
		colorTween = FlxTween.color(bg, 1, bg.color, colorToTween, {

...
class ClientPrefs {
	...
	public static var showExtraInfo:Bool = false;
	public static var flashing:Bool = true;
	public static var globalAntialiasing:Bool = true;
	public static var noteSplashes:Bool = true;
	public static var lowQuality:Bool = false;
	public static var shaders:Bool = true;
	public static var advancedShaders:Bool = true;
	...
	public static var wideScreenSongs = false;
	...
	public static var comboOffset:Array<Int> = [-230, -57, -174, -55];
	...
	public static function saveSettings() {
		...
		FlxG.save.data.showExtraInfo = showExtraInfo;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.showExtraInfo != null) {
			showExtraInfo = FlxG.save.data.showExtraInfo;
		}

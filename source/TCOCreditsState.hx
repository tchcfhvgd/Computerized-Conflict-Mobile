...
class TCOCreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		credits = [
			...
			new CreditsMetadata("Ne_Eo", "Ne_Eo", "Coder.", 0xFF533a38, "Hello USERNAME, how was your day?".replace("USERNAME", #if !web Sys.getEnv(#if mac "USER" #else "USERNAME" #end) #else "player" #end)),
			...
			new CreditsMetadata("noogai9876", "noogai", "Sprite Artist & Cutscene Maker (Adobe)", 0xFF5BFFDC, "Never gonna give you up, never gonna let you down, never gonna run around and desert you. Never gonna make you cry, never gonna say goodbye, never gonna tell you a lie and give you EMOTIONAL DAMAGE"),

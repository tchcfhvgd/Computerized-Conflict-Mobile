...
// THIS IS FOR TESTING
// DONT STEAL MY CODE >:(
// actually I don't careI just need a cool video
class VideoHandler2
{
	...
	public function playMP42(path:String, ?repeat:Bool = true, ?outputTo:FlxSprite = null, ?isWindow:Bool = false, ?isFullscreen:Bool = false, ?midSong:Bool = false):Void
	{
		if (!midSong)
		{

...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['cancel Tween Zoom', "Kills the tween zoom event lol"],
	...
	**/
	...
	var UI_composerTitle:FlxUIInputText;
	function addSongUI():Void
	{
		...
		tab_group_song.add(UI_composerTitle);
		...
		tab_group_song.add(new FlxText(UI_composerTitle.x, UI_composerTitle.y - 15, 0, 'Composer:'));
	...
	var check_bf3Section:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		tab_group_section.add(check_bf3Section);
	...
	override function update(elapsed:Float)
	{
		...
		_song.composer = UI_composerTitle.text;
	...
	*/
	...
	function updateSectionUI():Void
	{
		...
		check_bf3Section.checked = sec.bf3Section;
	...
	function updateHeads():Void
	{
		...
		if (_song.notes[curSec].mustHitSection)
		{
			...
			if (_song.notes[curSec].bf2Section) leftIcon.changeIcon('betaBF');
			if (_song.notes[curSec].bf3Section) leftIcon.changeIcon('dad');
		}
		else
		{
